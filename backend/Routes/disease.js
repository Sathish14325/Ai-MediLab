...
const diabetesModel = "../aimodels/diabetes.pkl";
const heartModel = "../aimodels/heart.pkl";
const kidneyModel = "../aimodels/kidney.pkl";
const liverModel = "../aimodels/kidney.pkl";
const breastCancerModel = "../aimodels/breast_cancer.pkl";

const pythonScriptPathForDiabetes = "../predict.py";
const pythonScriptPathForHeart = "../heart.py";
const pythonScriptPathForKidney = "../kidney.py";
const pythonScriptPathForLiver = "../kidney.py";
const pythonScriptPathForBreastCancer = "../breast-cancer.py";
